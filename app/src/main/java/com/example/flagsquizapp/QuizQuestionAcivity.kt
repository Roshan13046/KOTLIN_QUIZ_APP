...
import kotlinx.android.synthetic.main.activity_quiz_question_acivity.*

class QuizQuestionAcivity : AppCompatActivity() ,View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_quiz_question_acivity)
