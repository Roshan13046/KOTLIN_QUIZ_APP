...
class Flowers : AppCompatActivity() , View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(ConstantsFlower.USER_NAME)

        mQuestionList = ConstantsFlower.getQuestions()
...
//                            Toast.LENGTH_SHORT).show()
                        ...
                        intent.putExtra(ConstantsFlower.USER_NAME,mUserName)
                        intent.putExtra(ConstantsFlower.CORRECT_ANSWERS,mCorrectAnswers)
                        intent.putExtra(ConstantsFlower.TOTAL_QUESTIONS,mQuestionList!!.size)
