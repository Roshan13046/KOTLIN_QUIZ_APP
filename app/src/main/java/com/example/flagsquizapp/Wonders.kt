...
class Wonders : AppCompatActivity() , View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(ConstantsWonders.USER_NAME)

        mQuestionList = ConstantsWonders.getQuestions()
...
//                            Toast.LENGTH_SHORT).show()
                        ...
                        intent.putExtra(ConstantsWonders.USER_NAME,mUserName)
                        intent.putExtra(ConstantsWonders.CORRECT_ANSWERS,mCorrectAnswers)
                        intent.putExtra(ConstantsWonders.TOTAL_QUESTIONS,mQuestionList!!.size)
