...
class Capitals : AppCompatActivity() , View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(ConstantsCapitals.USER_NAME)

        mQuestionList = ConstantsCapitals.getQuestions()
...
//                            Toast.LENGTH_SHORT).show()
                        ...
                        intent.putExtra(ConstantsCapitals.USER_NAME,mUserName)
                        intent.putExtra(ConstantsCapitals.CORRECT_ANSWERS,mCorrectAnswers)
                        intent.putExtra(ConstantsCapitals.TOTAL_QUESTIONS,mQuestionList!!.size)
