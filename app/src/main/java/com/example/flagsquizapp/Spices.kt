...
import kotlinx.android.synthetic.main.activity_spices.*

class Spices : AppCompatActivity(), View.OnClickListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(ConstantsSpices.USER_NAME)

        mQuestionList = ConstantsSpices.getQuestions()
...
//                            Toast.LENGTH_SHORT).show()
                        ...
                        intent.putExtra(ConstantsSpices.USER_NAME,mUserName)
                        intent.putExtra(ConstantsSpices.CORRECT_ANSWERS,mCorrectAnswers)
                        intent.putExtra(ConstantsSpices.TOTAL_QUESTIONS,mQuestionList!!.size)
