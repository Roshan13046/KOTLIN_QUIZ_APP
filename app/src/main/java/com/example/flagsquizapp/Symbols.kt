...
class Symbols : AppCompatActivity() , View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(ConstantsSymbols.USER_NAME)

        mQuestionList = ConstantsSymbols.getQuestions()
...
//                            Toast.LENGTH_SHORT).show()
                        ...
                        intent.putExtra(ConstantsSymbols.USER_NAME,mUserName)
                        intent.putExtra(ConstantsSymbols.CORRECT_ANSWERS,mCorrectAnswers)
                        intent.putExtra(ConstantsSymbols.TOTAL_QUESTIONS,mQuestionList!!.size)
