...
class Vegetables : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(ConstantsVeg.USER_NAME)

        mQuestionList = ConstantsVeg.getQuestions()
...
//                            Toast.LENGTH_SHORT).show()
                        ...
                        intent.putExtra(ConstantsVeg.USER_NAME,mUserName)
                        intent.putExtra(ConstantsVeg.CORRECT_ANSWERS,mCorrectAnswers)
                        intent.putExtra(ConstantsVeg.TOTAL_QUESTIONS,mQuestionList!!.size)
